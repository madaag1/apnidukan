...
4. Open **Firestore Database â†’ Rules**, replace the existing rules with the contents of `firestore.rules`, then publish.
5. In **Authentication â†’ Settings â†’ Authorized domains**, confirm that `madaag1.github.io` is listed for the live GitHub Pages site. This is required for Google and phone sign-in.
